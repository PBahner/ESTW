...
Neopixel GlObenRechts2(neopixels, 32, 0, l4_2);
Neopixel GlUntenMitte(neopixels,  19, 0, l4_1);
Neopixel GlUntenRechts1(neopixels, 29, 0, l4_3);
Neopixel GlUntenRechts2(neopixels, 31, 0, l4_3);
Neopixel GlUntenRechts3(neopixels, 33, 0, l4_3);
...
void receiveEventCAN() {
  ...
  GlObenRechts2.updateleds(receive_data);
  GlUntenMitte.updateleds(receive_data);
  GlUntenRechts1.updateleds(receive_data);
  GlUntenRechts2.updateleds(receive_data);
  GlUntenRechts3.updateleds(receive_data);
